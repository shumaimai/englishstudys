...
英語のリスニング学習サイト。すべての処理を利用者の端末の中で行う。

---

## 作業を始める前に

1. **[`docs/HANDOVER.md`](docs/HANDOVER.md)** … 今どこまでできていて、次に何をするか
2. **[`docs/DECISIONS.md`](docs/DECISIONS.md)** … なぜそう作ったのか、検証で何が分かったのか

新しい会話や別の道具で作業を始めるときは、この2つを読めば追いつける。
